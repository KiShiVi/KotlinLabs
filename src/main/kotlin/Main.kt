...
//
//
//    val shapeFactory1 = ShapeFactorImpl()
//    val shapeCollector = ShapeCollector<Shape>()
//    val circleCollector = ShapeCollector<Circle>()
//
//    shapeCollector.add(shapeFactory1.createCircle(5.0))
//    shapeCollector.add(shapeFactory1.createSquare(6.0))
//    shapeCollector.add(shapeFactory1.createRectangle(4.0, 8.0))
//    shapeCollector.add(shapeFactory1.createTriangle(3.0, 4.0, 5.0))
//    shapeCollector.add(shapeFactory1.createRandomShape())
//
//    circleCollector.add(shapeFactory1.createCircle(5.0))
//    circleCollector.add(shapeFactory1.createCircle(4.0))
//    circleCollector.add(shapeFactory1.createCircle(10.0))
//
